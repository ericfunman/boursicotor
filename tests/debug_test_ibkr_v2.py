...
"""
Test IBKR avec création d'event loop au démarrage
"""
...
# SOLUTION ULTIME: Créer et définir l'event loop IMMÉDIATEMENT
if sys.platform == 'win32':
    asyncio.set_event_loop_policy(asyncio.WindowsSelectorEventLoopPolicy())

# Créer et définir l'event loop
...
print("=" * 60)
print("🔍 TEST DIRECT IBKR/LYNX (Python 3.14 compatible)")
print("=" * 60)
...
print(f"\n🔌 Connexion...")
print(f"   ⏳ Attente (timeout: 15 secondes)...")

try:
    ib = IB()
    ib.connect(host, port, clientId=999, timeout=15)
    ...
    print(f"\n✅ Rapport sauvegardé: ibkr_test_results.json")
